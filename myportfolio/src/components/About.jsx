  ...
  return (
    <div name='about' className='w-full min-h-screen bg-primary text-textLight py-16'>
      ...
      >        <motion.div 
        ...
        >
        ...
        </motion.div><div className='grid md:grid-cols-2 gap-12 items-start'>
          <motion.div 
            initial={{ x: -50, opacity: 0 }}
            animate={{ x: 0, opacity: 1 }}
            transition={{ delay: 0.4, duration: 0.6 }}
            className='md:text-right bg-white/5 backdrop-blur-sm rounded-xl p-6 shadow-xl shadow-black/5'
          >
            <h3 className='text-2xl sm:text-3xl font-medium mb-4 text-secondary'>
              Hi. I'm Joydeep De, nice to meet you. Please take a look around.
            </h3>
          </motion.div>
          ...
          <motion.div 
            ...
            className='space-y-4 text-textDark max-w-[600px] bg-white/5 backdrop-blur-sm rounded-xl p-6 shadow-xl shadow-black/5'
          >
