      ...
      <div className='hidden md:flex items-center'>
        <ul className='hidden md:flex mr-4'>
          <li className='relative group px-4'>
            <Link to='home' smooth={true} duration={500} className='hover:text-[var(--color-secondary)] transition-colors duration-300'>Home</Link>
          ...
          <li className='relative group px-4'>
            <Link to='about' smooth={true} duration={500} className='hover:text-[var(--color-secondary)] transition-colors duration-300'>About</Link>
            <span className='absolute left-0 bottom-[-4px] w-full h-[2px] bg-[var(--color-secondary)] transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300'></span>
          </li>
          <li className='relative group px-4'>
            <Link to='skills' smooth={true} duration={500} className='hover:text-[var(--color-secondary)] transition-colors duration-300'>Skills</Link>
            <span className='absolute left-0 bottom-[-4px] w-full h-[2px] bg-[var(--color-secondary)] transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300'></span>
          </li>
          <li className='relative group px-4'>
            <Link to='work' smooth={true} duration={500} className='hover:text-[var(--color-secondary)] transition-colors duration-300'>Work</Link>
            <span className='absolute left-0 bottom-[-4px] w-full h-[2px] bg-[var(--color-secondary)] transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300'></span>
          </li>
          <li className='relative group px-4'>
            <Link to='contact' smooth={true} duration={500} className='hover:text-[var(--color-secondary)] transition-colors duration-300'>Contact</Link>
            <span className='absolute left-0 bottom-[-4px] w-full h-[2px] bg-[var(--color-secondary)] transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300'></span>
          </li>
        </ul>
